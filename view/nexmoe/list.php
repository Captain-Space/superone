...
<?php function file_ico($item){
    ...
    <div class="nexmoe-item">
        <div class="mdui-row">
            <ul class="mdui-list">
                ...
                <li id="<?php echo$item["id"] ?>" class="mdui-list-item mdui-ripple fk" data-sort data-sort-name="<?php e($item['name']);?>"
    ...
    <?php if($readme):?>
    <div class="mdui-typo mdui-shadow-3" style="padding: 20px;margin: 1px; 0">
        <div class="mdui-chip">
