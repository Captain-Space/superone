...
.thumb .forcedownload {
    display: none; }
     .mdui-checkbox-icon::after{ border-color: transparent; }
...
<div class="mdui-row">
  ...
  <i class="mdui-checkbox-icon"></i></label>
		...
		<li  class="mdui-list-item mdui-ripple fk" data-sort data-sort-name="<?php e($item['name']);?>" data-sort-date="<?php echo $item['lastModifiedDateTime'];?>" data-sort-size="<?php echo $item['size'];?>" style="padding-right:36px; " >
		    <label class="mdui-checkbox">
