...
{$base=config("@base");
 ...
 $base["password"]=$_REQUEST["title_name"];
    ...
    config("@base",$base);
     setcookie('admin', $base["password"]);
      header("refresh:5;url=/admin/drives");print('正在加载配置，请稍等...<br>五秒后自动跳转。');;
  exit;
    ...
    <form class="layui-form layui-form-pane" action="install3.php" method="get">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline w300">
                <input type="text" class="layui-input" name="site_name"  value="oneindex">
            </div>
        ...
        <div class="step-btns">
            <a href="http://x.mxin.ltd/?step=2" class="layui-btn layui-btn-primary layui-btn-big fl">返回上一步</a>
